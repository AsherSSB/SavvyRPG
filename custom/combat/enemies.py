...
class TrainingDummy(Enemy):
    def __init__(self):
        ...
        self.stats = NPCStatTable(120, 1.0, 0.0, 1)
...
class Wolf(Enemy):
    def __init__(self):
        self.name = "Wolf"
        self.stats = NPCStatTable(80, 0.9, 0.15, 3)  # Less HP but high dodgeclass wolf
...
class Bandit(Enemy):
    def __init__(self):
        self.name = "Bandit"
        self.stats = NPCStatTable(100, 0.85, 0.15, 2)  # Balanced stats
...
class Skeleton(Enemy):
    def __init__(self):
        self.name = "Skeleton"
        self.stats = NPCStatTable(70, 0.7, 0.05, 1)  # High resist, low dodge
...
class DarkMage(Enemy):
    def __init__(self):
        self.name = "Dark Mage"
        self.stats = NPCStatTable(90, 0.8, 0.1, 1)
...
class Golem(Enemy):
    def __init__(self):
        ...
        self.stats = NPCStatTable(200, 0.6, 0.0, 2)  # Very high HP and resist, no dodge
