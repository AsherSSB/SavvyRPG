...
class Wolf(Enemy):
    def __init__(self):
        self.name = "Wolf"
        self.stats = NPCStatTable(80, 0.1, 0.2)  # Less HP but high dodge
...
class Bandit(Enemy):
    def __init__(self):
        self.name = "Bandit"
        self.stats = NPCStatTable(100, 0.15, 0.15)  # Balanced stats
...
class Skeleton(Enemy):
    def __init__(self):
        self.name = "Skeleton"
        self.stats = NPCStatTable(70, 0.3, 0.05)  # High resist, low dodge
...
class DarkMage(Enemy):
    def __init__(self):
        self.name = "Dark Mage"
        self.stats = NPCStatTable(90, 0.2, 0.1)
...
class Golem(Enemy):
    def __init__(self):
        ...
        self.stats = NPCStatTable(200, 0.4, 0.0)  # Very high HP and resist, no dodge
